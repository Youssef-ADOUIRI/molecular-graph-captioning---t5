...
class MolecularCaptionDataset(Dataset):
    ...
    def __init__(
        self,
        graph_path: str,
        tokenizer_name: str = "laituan245/molt5-base",
        max_length: int = 256,
        is_test: bool = False,
    ):
        """
...
def get_dataloaders(
    ...
    train_ds = MolecularCaptionDataset(
        train_path, tokenizer_name=tokenizer_name, max_length=max_length, is_test=False
    )

    val_ds = MolecularCaptionDataset(
        val_path, tokenizer_name=tokenizer_name, max_length=max_length, is_test=False
    )
